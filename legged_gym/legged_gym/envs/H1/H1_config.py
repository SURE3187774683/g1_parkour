...
class H1RoughCfgPPO( LeggedRobotCfgPPO ):
    ...
    class runner( LeggedRobotCfgPPO.runner ):
        ...
        # run_name = "".join(["H1",
        #     ("_pEnergy" + np.format_float_scientific(H1RoughCfg.rewards.scales.energy_substeps, precision= 1, trim= "-") if H1RoughCfg.rewards.scales.energy_substeps != 0 else ""),
        #     ("_pDofErr" + np.format_float_scientific(H1RoughCfg.rewards.scales.dof_error, precision= 1, trim= "-") if H1RoughCfg.rewards.scales.dof_error != 0 else ""),
        #     # ("_pDofErrN" + np.format_float_scientific(H1RoughCfg.rewards.scales.dof_error_named, precision= 1, trim= "-") if H1RoughCfg.rewards.scales.dof_error_named != 0 else ""),
        #     ("_pStand" + np.format_float_scientific(H1RoughCfg.rewards.scales.stand_still, precision= 1, trim= "-") if H1RoughCfg.rewards.scales.stand_still != 0 else ""),
